...
const renderItem = (type, _item, isLoading, selectedItemIndex, setSelectedItemIndex, data, onItemPress) => {
...
export default function PSHorizontalScroller ({
  ...
  return (
    <FlatList
      ...
      renderItem={item => renderItem(type, item, isLoading, selectedItemIndex, setSelectedItemIndex, data, onItemPress)}
      horizontal
      bounces={false}
